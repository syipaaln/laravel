...
<head>
	...
	<title>Admin page - Register</title>
    <!-- ========== Favicon Icon ========== -->
...
@if ($errors->any())
		...
		@endif
            ...
            <hr>
			<input class="input100" data-validate="Valid fullname is required: ex@abc.xyz" name="fullname" placeholder="name" />
			<input class="input100" data-validate="Valid email is required: ex@abc.xyz" type="email" name="email" placeholder="Email" />
